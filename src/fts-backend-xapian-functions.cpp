...
{
	if(fts_xapian_settings.verbose>0) i_info("FTS Xapian: fts_backend_xapian_index %s : %ld",field,data->length());
	...
	if(fts_xapian_settings.verbose>0) i_info("FTS Xapian: fts_backend_xapian_index %s done",field);
